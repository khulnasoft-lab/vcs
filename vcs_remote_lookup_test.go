...
func TestVCSLookup(t *testing.T) {
	...
	urlList := map[string]struct {
		...
		"https://github.com/khulnasoft-lab":                                {work: false, t: Git},
		"https://github.com/khulnasoft-lab/vcs/VCSTestRepo":                {work: true, t: Git},
		...
		"git@github.com:Khulnasoft-lab/vcs.git":                            {work: true, t: Git},
		...
		"http://hg.code.sf.net/p/khulnasoft-lab/test":                      {work: true, t: Hg},
		"http://git.code.sf.net/p/khulnasoft-lab/test":                     {work: true, t: Git},
		"http://svn.code.sf.net/p/khulnasoft-lab/test":                     {work: true, t: Svn},
	}
